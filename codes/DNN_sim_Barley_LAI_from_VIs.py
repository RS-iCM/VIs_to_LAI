###################################################################
### DNN regression model to simulate LAI using VIs data for barley
### Input: Rice VIs and LAI data "Barley_LAI_n_VIs.csv"
### Output: Pickle model "barley_NN.h5"
...
df = pd.read_csv('data/Barley_LAI_n_VIs.csv')  # Barley LAI and VIs data
...
model.save('models/barley_NN.h5')
