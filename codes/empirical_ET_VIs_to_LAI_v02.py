...
def ML_VIs_to_LAI(n_obs,n_doys,n_pixels,sat_opt,start_doy,rs_data,paddyFields_data,plantingDate_data,cg_period):
...
def main(cwd, paddy_data_dir, output_dir, map_dir, IO_file_path):
    ...
    if split_op == 0:
        ...
        sub_OLAI_data, sub_arr_mMLAI = ML_VIs_to_LAI(n_obs,n_doys,n_pixels,sat_opt,start_doy,rs_data,
                                         sub_paddyFields,sub_plantingDate, cg_period)
