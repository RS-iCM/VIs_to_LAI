...
def main(cwd, paddy_data_dir, output_dir, map_dir, IO_file_path):
    ...
    if split_op == 0:
        ...
        sub_OLAI_data, sub_arr_mMLAI =         empirical_VIs_to_lai(n_vi,n_obs,n_doys,n_pixels,sat_opt,start_doy,rs_data,sub_paddyFields,sub_plantingDate,cg_period,params)
    ...
    if split_op == 1:   
        ...
        for isplit in range(nsplits + 1):
            ...
            sub_OLAI_data, sub_arr_mMLAI = empirical_VIs_to_lai(n_vi,n_obs,n_doys,
                                                        ...
                                                        sub_paddyFields,sub_plantingDate,cg_period,params)    
